...
class ScanSubInventory extends ScanSubCommand
{
    public function __construct()
    {
        parent::__construct("inventory", "Scan inventory", []);
    }
    ...
    protected function prepare(): void
    {
        ...
        $this->setPermission("scan.inventory");
    }
    ...
    public function onNormalRun(Player $sender, string $aliasUsed, array $args): void
    {
        ...
        $task = new ScanInventoryTask($players, count($players), $id, $meta, $min, $sender, ScanInventoryTask::INVENTORY);
